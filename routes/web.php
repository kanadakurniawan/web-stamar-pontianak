...
# Kuisioner
Route::controller(RootController::class)->prefix('kuisioner')->name('kuisioner.')->group(function () {
...
# Pelayanan Publik
Route::controller(RootController::class)->prefix('layanan-publik')->name('layanan-publik.')->group(function () {
